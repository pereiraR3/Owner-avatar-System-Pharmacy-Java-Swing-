...
public class Sobre extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Anthony Ricardo Rodrigues Rezende");

        jLabel3.setText("Letízia Manuella ");

        jLabel4.setText("Vinícius Padilha Vieira");
        ...
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Criar um sistema para farmácias ", "que seja simples, mas completo que ", "possa atender às necessidades de ", "cadastros, consultas e eliminação ", "de dados." };
